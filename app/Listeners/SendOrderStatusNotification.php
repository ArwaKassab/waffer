...
class SendOrderStatusNotification implements ShouldQueue
{
    ...
    private function buildUserMessage(string $status, int $orderId): array
    {
        ...
        return match ($status) {
            ...
            'مقبول' => [
                'تم قبول طلبك',
                "ممتاز! طلبك رقم #{$orderId} تم قبوله وبدأنا بتجهيزه.",
            ],
            'يجهز' => [
                'طلبك قيد التجهيز',
                "طلبك رقم #{$orderId} قيد التجهيز. سنبلغك حين يصبح جاهز.",
            ],
            'حضر' => [
                'طلبك صار جاهز',
                "طلبك رقم #{$orderId} صار جاهز وبطريقه لعندك. تابع تفاصيله من صفحة الطلب.",
            ],
            'مستلم' => [
                'طلبك صار عندك',
                "طلبك رقم #{$orderId} صار عندك.",
            ],
            'مرفوض' => [
                'تعذر تنفيذ طلبك',
